 ...
 * _resetBackoffState().
 *
 * Callers should check isAtCap first; this function latches regardless of
 * whether the channel is at cap, but in normal usage it is called only when
 * isAtCap returns true.
 */
